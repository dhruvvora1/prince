      ...
      <Navbar expand="lg" className="main-header side-header sticky">
        <Container fluid className="main-container">
          <div className="main-header-left">
            <Link
              to={`${process.env.REACT_APP_HOME_PAGE_URL}/dashboard/`}
          ...
          <div className="main-header-center">
            <div className="responsive-logo">
              <Link to={`${process.env.REACT_APP_HOME_PAGE_URL}/dashboard/`}>
                <img
                  src={require("../../../assets/img/brand/logo.png")}
                ...
                <div className="d-flex order-lg-2 align-items-center ms-auto">
                  ...
                  <div className="main-header-notification">
                    <Link
                      ...
                      to={`${process.env.REACT_APP_HOME_PAGE_URL}/advanceUI/chat/`}
                    >
                  ...
                  <Dropdown className="main-profile-menu">
                    ...
                    <Dropdown.Menu style={{ margin: "0px" }}>
                      ...
                      <Dropdown.Item
                        ...
                        href={`${process.env.REACT_APP_HOME_PAGE_URL}/pages/profile`}
                      >
